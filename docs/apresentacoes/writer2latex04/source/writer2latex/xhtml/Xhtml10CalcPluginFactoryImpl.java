 ...
 */
public final class Xhtml10CalcPluginFactoryImpl extends PluginFactory 
    ...
    */
    public Xhtml10CalcPluginFactoryImpl (ConverterInfo ci) {
        super(ci);
    }
   
    /**
     *  <p>The <code>DocumentSerializer</code> is used to convert 
     *  from the OpenOffice Calc <code>Document</code> format 
