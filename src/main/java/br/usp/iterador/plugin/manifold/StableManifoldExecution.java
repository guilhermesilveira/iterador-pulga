...
public class StableManifoldExecution implements PulgaAction {
	...
	private static final Logger LOG = Logger
			.getLogger(StableManifoldExecution.class);

	public void execute(Application app, WindowManager windows,
			StableManifoldData data, SimpleIteratorFrame frame,
		...
		StableManifoldExecutorListener listener = new StableManifoldExecutorListener(
				app, focus, pluginManager);
