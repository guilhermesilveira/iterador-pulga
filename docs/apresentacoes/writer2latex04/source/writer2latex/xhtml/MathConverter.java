...
public class MathConverter extends ConverterHelper {
    ...
    public MathConverter(WriterStyleCollection wsc, Config config, DocumentSerializerImpl converter,
    ...
    private char replacePrivateChar(char c) {
        switch (c) {
            ...
            case '\uE0DD': return '\u2193';
            default: 
                //if (c>='\uE000' && c<='\uF8FF') { System.out.println("Private use: "+Integer.toHexString((int)c)); }
                return c;
        }
    }
